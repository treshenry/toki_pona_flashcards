defmodule TokiPonaFlashcardsWeb.CardLiveTest do
  use TokiPonaFlashcardsWeb.ConnCase

  import Phoenix.LiveViewTest
  import TokiPonaFlashcards.CardsFixtures

  @create_attrs %{front: "some front", back: "some back", front_sitelen: true, back_sitelen: true}
  @update_attrs %{front: "some updated front", back: "some updated back", front_sitelen: false, back_sitelen: false}
  @invalid_attrs %{front: nil, back: nil, front_sitelen: false, back_sitelen: false}
